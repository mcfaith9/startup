...
<section class="about">
    ...
    <div class="hidden-content">
        ...
        <div class="contact-page content-wrapper">
            <p>As we said, we came  from the Philippines, where we inspire this project in behalf of our school <a target="_blank" href="https://www.google.com.ph/maps/place/South+Poblacion,+City+of+Naga,+Cebu/@10.2019481,123.7501173,16z/data=!4m5!3m4!1s0x33a9785459bad58d:0xfb8b45e305069e6a!8m2!3d10.2017431!4d123.7559628" class="btnInline">Professional Academy of the Philippines</a>.</p>
            <p>If you have any questions, please contact us. We are on basically every social network you can imagine - <a href="#" class="btn facebook">TeamPila@facebook.com</a>, <a href="#" class="btnInline twitter">TeamPila@twitter.com</a>, <a href="#" class="btnInline instagram">TeamPila@instagram.com</a>. So contacting us should not be a problem.</p>
